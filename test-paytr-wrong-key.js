...
async function testPaytr() {
  const merchant_id = "735770";
  const merchant_key = "8Znf7RgqbWaar2B5"; // Try with a wrong key by appending space
  const merchant_salt = "iF9zPQq1UbZ4Xoeo";
  ...
  // INTENTIONALLY BREAKING THE HASH BY ADDING A SPACE TO THE KEY
  ...
  try {
    ...
    console.log('PAYTR RESPONSE FOR WRONG KEY:', text);
  } catch(e) {
    console.error(e);
  }
}
